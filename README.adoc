...
The model is used in the last step of the _etching_ process to create a record for further use by your application. Here's an example where a {data_link} model is used:
